...
func GetBrowserClassification() []BrowserCategory {
	return []BrowserCategory{
		...
		* Firefox (Debian trademark policy) */
		...
		{Agent: "YandexMobileBot", Category: "Crawlers"},
		{Agent: "YandexMetrika", Category: "Crawlers"},
		...
		{Agent: "Slack-ImgProxy", Category: "Crawlers"},
		...
		{Agent: "coccocbot", Category: "Crawlers"},
		{Agent: "centurybot9", Category: "Crawlers"},
		{Agent: "Alignabot", Category: "Crawlers"},
		{Agent: "zgrab", Category: "Crawlers"},
		{Agent: "BackupLand", Category: "Crawlers"},
		{Agent: "CloudFlare-AlwaysOnline", Category: "Crawlers"},
		{Agent: "MetaJobBot", Category: "Crawlers"},
		{Agent: "Jobsearch", Category: "Crawlers"},
		{Agent: "SeznamBot", Category: "Crawlers"},
		{Agent: "JobboerseBot", Category: "Crawlers"},
		{Agent: "adbeat_bot", Category: "Crawlers"},
		{Agent: "hokifyBot", Category: "Crawlers"},
		...
		{Agent: "DuckDuckGo", Category: "Crawlers"},
		...
		{Agent: "BloggeramtFeedFetcher", Category: "Feeds"},
		{Agent: "google-xrawler", Category: "Feeds"},
